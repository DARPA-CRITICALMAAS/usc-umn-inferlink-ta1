...
def parse_arguments():
    ...
    parser.add_argument("--map_dir", type=str, default="/Users/dong_dong_dong/Downloads/Darpa/data/sample/raw_map",
                        help="Directory to the original map data ended with .tif.")
    parser.add_argument("--map_metadata_dir", type=str, default="/Users/dong_dong_dong/Downloads/Darpa/data/sample/map_metadata",
                        help="Directory to map metadata that contains the information about coordinate of legend and map dimension.")
    parser.add_argument("--cropped_legend_dir", type=str, default="/Users/dong_dong_dong/Downloads/Darpa/data/sample/labels",
    ...
    parser.add_argument("--processed_legend_dir", type=str, default="/Users/dong_dong_dong/Downloads/Darpa/data/sample/labels_processed",
                        help="Directory to save the processed cropped legend")
    parser.add_argument("--map_patches_dir", type=str, default="/Users/dong_dong_dong/Downloads/Darpa/data/sample/cropped_eval",
    ...
    parser.add_argument("--output_dir_root", type=str, default="/Users/dong_dong_dong/Downloads/Darpa/data/sample/model_output_pipeline",
