...
def setting_summary():
    print('========================================== Setting of Metadata Preprocessing for Polygon Extraction ==========================================')
    print('*Preprocessing output directory => "' + solutiona_dir + '"')
...
def worker_preprocessing():
    print('')
    print('=== Preparing basemaps with different representations / Checking area segmentation ===')
            ...
            for looping in range(0, looping_times):
                ...
                if efficiency_trade_off <= 0:
                    ...
                    if poly_counter >= 5 and poly_counter <= 150:
                        ...
                        print('Text-pattern matching with connected-component analysis is finished...')
                        ans_category = np.copy(temp_ans_category)

                    else:
                        print('no text-pattern matching with connected-component analysis is needed...')
                        running_time_v.append(datetime.now()-runningtime_start)
                        running_time_v.append(datetime.now()-runningtime_start)
                        running_time_v.append(datetime.now()-runningtime_start)
                        running_time_v.append(datetime.now()-runningtime_start)
