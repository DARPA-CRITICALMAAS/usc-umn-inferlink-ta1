...
def polygon_schema_worker(this_abbr, info_for_this_poly, linking_ids, candidate_info, map_name, fname, dir_to_raster_polygon, dir_to_integrated_output, targeted_crs):
    ...
    out_path = os.path.join(dir_to_integrated_output, 'LOAM_LINK_Intermediate', map_name, fname.replace('_predict.tif', '.geojson'))
    ...
    try:
        polygon_extraction = gpd.read_file(os.path.join(dir_to_integrated_output, 'LOAM_LINK_Intermediate', map_name, fname.replace('_predict.tif', '.geojson')), driver='GeoJSON')
        ...
        if debugging_for_unreproducible_error:
            ...
            mirrored_polygon.to_file(os.path.join(dir_to_integrated_output, 'LOAM_LINK_Intermediate', map_name, 'temp_0', fname.replace('_predict.tif', '_PolygonFeature.geojson')), driver='GeoJSON')
        ...
        for index, poi in mirrored_polygon.iterrows():
            ...
            if debugging_for_unreproducible_error and index == 0:
                f = open(os.path.join(dir_to_integrated_output, 'LOAM_LINK_Intermediate', map_name, 'temp_0', fname.replace('_predict.tif', '_PolygonFeature_breakdown.txt')), 'w')
                f.write(fname.replace('_predict.tif', ''))
                f.write('\n\npoi["geometry"]: \n' + str(poi['geometry']))
                this_reduced_polygon = poi['geometry'].simplify(0.9, preserve_topology=True)
        ...
        if debugging_for_unreproducible_error:
            mirrored_polygon = mirrored_polygon.set_crs('epsg:3857', allow_override=True)
            mirrored_polygon.to_file(os.path.join(dir_to_integrated_output, 'LOAM_LINK_Intermediate', map_name, 'temp_1', fname.replace('_predict.tif', '_PolygonFeature.geojson')), driver='GeoJSON')
        ...
        if debugging_for_unreproducible_error:
            mirrored_polygon = mirrored_polygon.set_crs('epsg:3857', allow_override=True)
            mirrored_polygon.to_file(os.path.join(dir_to_integrated_output, 'LOAM_LINK_Intermediate', map_name, 'temp_2', fname.replace('_predict.tif', '_PolygonFeature.geojson')), driver='GeoJSON')
        ...
        mirrored_polygon = mirrored_polygon.set_crs('epsg:3857', allow_override=True)
        mirrored_polygon.to_file(os.path.join(dir_to_integrated_output, 'LOAM_LINK_Intermediate', map_name, fname.replace('_predict.tif', '_v2.geojson')), driver='GeoJSON')
        ...
        polygon_extraction = gpd.read_file(os.path.join(dir_to_integrated_output, 'LOAM_LINK_Intermediate', map_name, fname.replace('_predict.tif', '_v2.geojson')), driver='GeoJSON')
        ...
        mirrored_polygon.to_file(os.path.join(dir_to_integrated_output, 'LOAM_LINK_Intermediate', map_name, fname.replace('_predict.tif', '_v3.geojson')), driver='GeoJSON')



        with open(os.path.join(dir_to_integrated_output, 'LOAM_LINK_Intermediate', map_name, fname.replace('_predict.tif', '_v3.geojson')),) as f:
            gj = json.load(f)
        ...
        with open(os.path.join(dir_to_integrated_output, map_name, fname.replace('_predict.tif', '_PolygonFeature.geojson')), 'w') as outfile: 
