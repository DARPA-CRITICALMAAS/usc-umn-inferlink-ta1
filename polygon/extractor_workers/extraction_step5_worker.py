...
def extraction_step5_worker(legend, map_name, legend_name, solutiona_dir, dir_to_raster_output, print_intermediate_image, rgb_rb, hsv_ms, this_current_result, iteration, global_solution_empty, img_crop_black_and_gray, conv_kernel_set, conv_kernel_threshold, masking):
