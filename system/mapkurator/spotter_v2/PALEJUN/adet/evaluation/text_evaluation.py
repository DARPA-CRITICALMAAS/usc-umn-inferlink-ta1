...
class TextEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        ...
        if "totaltext" in dataset_name:
            self._text_eval_gt_path = "/data/yijun/rumsey/spotter-data/evaluation/gt_totaltext.zip"
            self._word_spotting = True
        elif "icdar2015" in dataset_name:
            self._text_eval_gt_path = "/data/yijun/rumsey/spotter-data/evaluation/gt_icdar2015.zip"
            self._word_spotting = False
        elif "weinman" in dataset_name:
            self._text_eval_gt_path = "/data/yijun/rumsey/WeinmanDataset/weinman-val-500/gt.zip"
            self._word_spotting = False
        elif "rumsey" in dataset_name:
            self._text_eval_gt_path = "/data/yijun/rumsey/RumseyDataset/rumsey-val-300/gt.zip"
            self._word_spotting = False
        else:
